...
public class Main {
    public static void main(String[] args) {
        ...
        if (conexion == null) {
            System.out.println("Error: No se pudo conectar a la base de datos. Verifique su conexión y vuelva a intentarlo.");
            return;
        }
        ...
        while (continuar) {
            try {
                ...
                System.out.println("26. Pagar reserva");
